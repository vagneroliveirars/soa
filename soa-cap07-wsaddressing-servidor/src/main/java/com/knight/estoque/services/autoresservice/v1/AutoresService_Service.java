 ...
 * 
 */
@WebServiceClient(name = "AutoresService", targetNamespace = "http://knight.com/estoque/services/AutoresService/v1", wsdlLocation = "file:/home/vagner/git/soa/soa-cap07-wsaddressing-servidor/src/main/webapp/WEB-INF/contracts/AutoresService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/home/vagner/git/soa/soa-cap07-wsaddressing-servidor/src/main/webapp/WEB-INF/contracts/AutoresService.wsdl");
