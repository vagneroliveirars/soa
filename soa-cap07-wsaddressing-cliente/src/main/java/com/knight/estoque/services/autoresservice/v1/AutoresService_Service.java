 ...
 * 
 */
@WebServiceClient(name = "AutoresService", targetNamespace = "http://knight.com/estoque/services/AutoresService/v1", wsdlLocation = "http://localhost:8080/soa-cap07-wsaddressing-servidor/AutoresService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/soa-cap07-wsaddressing-servidor/AutoresService?wsdl");
